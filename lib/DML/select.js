...
const SelectFnc = function (table, output, filter, done) {
    const command = commandCreate(table, output, filter);
...
const commandCreate = function (table, output, filter) {
...
module.exports.Select = SelectFnc;